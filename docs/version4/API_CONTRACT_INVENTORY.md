...
| Auth | Admin | `/api/v1/auth/invites`, `/api/v1/auth/users`, `/api/v1/auth/users/{profile_id}` |
| System | System Admin | `/api/v1/system/dashboard`, `/api/v1/system/organizations`, `/api/v1/system/organizations/{organization_id}/admin-invites` |
| Learning | Teacher | `/api/v1/courses`, `/api/v1/courses/{course_id}/classes`, `/api/v1/classes/{class_id}`, `/api/v1/classes/{class_id}/students`, `/api/v1/students` |
...
| Knowledge | Teacher/Admin/Student theo scope policy | `/api/v1/documents`, `/api/v1/documents/upload`, `/api/v1/documents/ingest-url`, `/api/v1/documents/{document_id}`, `/api/v1/documents/{document_id}/archive`, `/api/v1/documents/{document_id}/reindex` |
...
| Lessons | Teacher owner/Admin same org/Student published membership | `/api/v1/lesson-blocks/{block_id}`, `/api/v1/lesson-blocks/{block_id}/status`, `/api/v1/lessons/{lesson_id}`, `/api/v1/lessons/{lesson_id}/submit`, `/api/v1/lessons/{lesson_id}/audit-events`, `/api/v1/lessons/{lesson_id}/exports` |
...
- Swagger tags must stay stable: Health, Auth, System, Learning, Knowledge, AI Generation, Lessons, Admin, Teacher, Student, Jobs.
